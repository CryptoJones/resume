...
Ingeniero de Software Principal con m\'as de 25 a\~nos de experiencia en ingenier\'ia de software, ciberseguridad e infraestructura en la nube. Actualmente dise\~nando sistemas y construyendo canalizaciones de ML para una startup de IA. El trabajo previo abarca defensa, manufactura, operaciones en la nube y seguridad de la informaci\'on. CISSP en progreso.
\end{rSection}
...
IA/ML & LangChain, LangGraph, Hugging Face, OpenAI API, Anthropic API, Ollama, canalizaciones RAG, bases de datos vectoriales (pgvector, Pinecone), ingenier\'ia de prompts\\
...
Certificaciones & CISSP (En Progreso), SSCP, AWS Solutions Architect Associate, AWS Cloud Practitioner, CompTIA A+, CompTIA Network+, MS: Programming in C\#\\
