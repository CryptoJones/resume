...
\item Ran a cybersecurity consultancy. Focused on Training and Technical Audits.
\end{rSubsection}
...
\item Swapped backup tapes, reset passwords, recycled print queues.
\end{rSubsection}
...
Certifications & CISSP (In-Progress), SSCP, AWS SSA, A+, Network+, CCNA (expired), MCSA
\end{tabular}
