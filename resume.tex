...
\begin{rSubsection}{Tmutla, Inc.}{Jan 2021 - Present}{Application Security Consultant}{Remote}
\item Performed application security audits and code reviews on legacy code bases
\item Prepared reports on vulnerability enumeration and remediation recommendations
\item Taught application security hygiene to developers
\end{rSubsection}

\begin{rSubsection}{Reinke Manufacturing Company, Inc.}{Dec 2015 - Jan 2021}{Senior Software Developer}{Remote}
...
\item Acted as Information Assurance Manager for Headquarters \& Service Co.
\end{rSubsection}
