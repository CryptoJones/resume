...
\begin{rSubsection}{CrowdStrike}{2022 - 2023}{Technical Support Engineer II}{Remote}
	\item SME for both SaaS and on-prem Humio/LogScale, Kafka, and log shippers. Focused on user education and training. Wrote automation in Bash and Python.
\end{rSubsection}
...
Tools & Visual Studio, dotPeek, Burp Suite, Postman, Wireshark, NMap, LogScale, Humio, Kafka\\
Languages & C\#, VB.NET, T-SQL, JavaScript, Powershell, Python\\
Memberships & OWASP, ACM, DC402, RITSEC, SPARSA.ORG, OperationCode\\
Certifications & SSCP, AWS Solutions Architect Associate, A+, Network+, CCNA (expired), MCSA
\end{tabular}
