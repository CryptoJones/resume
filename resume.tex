...
\address{PO BOX 28 MINDEN, NE 68959 } % Your address
\address{\href{tel:15712975406}{(571)~$\cdot$~297~$\cdot$~5406} \\ \href{mailto:aaron.clark@milcyber.org}{aaron.clark@milcyber.org}} % Your phone number and email
...
\begin{rSubsection}{Ronin 48}{2026 - Present}{ML Architect}{Remote}
	\item Consultating Architect for AI Startup
\end{rSubsection}

\begin{rSubsection}{SemperDucked, LLC}{2026 - Present}{Producer}{Worldwide}
	\item Documented the Stories of Stateside and expat U.S. Military Veterans for podcast and YouTube consumption..
\end{rSubsection}

\begin{rSubsection}{Nebraska Veteran's Stories}{2026 - Present}{Producer}{Central Nebraska}
	\item Documented the Stories of Nebraska Veterans for podcast and YouTube consumption..
\end{rSubsection}

\begin{rSubsection}{StarLight.Photos}{2023 - Present}{Photographer/Videographer}{Central Nebraska}
	\item Created still and video products for customers. Edited RAW Photos in Lightroom and Video in Davinci Resolve.
\end{rSubsection}
...
Certifications & CISSP (Pending), SSCP, AWS SAA, A+, Network+, CCNA, MCSA
\end{tabular}
